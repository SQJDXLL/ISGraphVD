...
train_dataset = []
for train_batch in training_data_iter:
    if config["training"]["mode"] == "pair":
        node_features, edge_features, from_idx, to_idx, graph_idx, labels = get_graph(train_batch)
        train_dataset.append((node_features, edge_features, from_idx, to_idx, graph_idx, labels))
    else:
        node_features, edge_features, from_idx, to_idx, graph_idx = get_graph(train_batch)
        train_dataset.append((node_features, edge_features, from_idx, to_idx, graph_idx))
...
for train_batch_idx, train_batch in enumerate(train_dataset):
    ...
    if config["training"]["mode"] == "pair":
        node_features, edge_features, from_idx, to_idx, graph_idx, labels = train_batch
        labels = labels.to(device)
    else:
        node_features, edge_features, from_idx, to_idx, graph_idx = train_batch
    # print(f"===========================\n{from_idx.shape}\n===========================")
    # print(f"===========================\n{to_idx.shape}\n===========================")
