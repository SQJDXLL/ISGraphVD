...
if __name__ == "__main__":
    ...
    if hl:
        ...
        if utils.GRAPH_MODE == 'single':
            from data.settings import vul_dict
    ...
    for proj, cve_dict in vul_dict.items():
        ...
        for cve in cve_dict.keys():
            ...
            acc = (true_positive_count + true_negative_count) / (true_positive_count + true_negative_count + false_positive_count + false_negative_count)

             
            print('[Info] ACC: {:.4f}'.format(acc))